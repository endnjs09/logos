...
def build_executor_prompt(project_root: Path, plan_id: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "- Do not directly create or edit `.logos/plans/<plan_id>/execution-result.json`.",
            "- Return the execution result JSON in the final response; Runner materializes the official result.",
            "- Do not expand scope.",
